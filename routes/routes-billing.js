...
router.get('/financial_report', requireLoggedIn, function(req, res){
	...
	// 		},
	// 		attributes: ['id', 'conf_date'],
	// 		group: ['inpatient_treatment.id', 'inpatient_treatment.conf_date', 'parent_record.id', 'parent_record.check_up_type', 'parent_record.hospitalName', 'parent_record.doctorId', 'parent_record.patientId', 'parent_record->billing_items.checkUpId'],
	// 		include: [{
	// 			model: Check_Up,
	// 			as: 'parent_record',
	// 			required: true,
	...
	// 			},
	// 			attributes: ['id', 'date'],
	// 			group: ['outpatient_treatment.id', 'outpatient_treatment.date', 'parent_record.id', 'parent_record.check_up_type', 'parent_record.hospitalName', 'parent_record.doctorId', 'parent_record.patientId', 'parent_record->billing_items.checkUpId'],
	// 			include: [{
	// 				model: Check_Up,
	// 				as: 'parent_record',
	// 				required: true,
	...
	// 					active: true,
	// 				},
	// 				group: ['consultation.id', 'consultation.date', 'parent_record.id', 'parent_record.check_up_type', 'parent_record.hospitalName', 'parent_record.doctorId', 'parent_record.patientId', 'parent_record->billing_items.checkUpId'],
	// 				include: [{
	// 					model: Check_Up,
	// 					as: 'parent_record',
	// 					required: true,
